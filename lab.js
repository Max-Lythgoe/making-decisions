...
//   console.log (`A t-shirt is fine, no need for a jacket.`)
// } else if (temperature >= 60 && rain === false) {
//   console.log (`Jacket is optional today but it's mostly warm.`)
// } else if (temperature < 60 && rain === false) {
//   console.log (`You may want to wear a warm coat today, but no need for an umbrella.`)
// }
...
//   console.log(`Your score is not high enough. Your current score is ${score}.`);
